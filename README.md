...
We have tested LRTK with Aquila==1.0.0, bcftools==1.8, bwa==0.7.17, fastp==0.23.2, freebayes==0.9.21, gatk==3.8, hapcut2==1.3.3, samtools==1.6, SpecHap==1.0.1, VALOR==2.1.5, whatshap==1.2.1.   

...
def stLFR210x(infq1, infq2, outfq1, outfq2, bin):
	...
	#Format conversion
	subprocess.call(["sh", bin+"/bin/extract.bq.stLFR.sh", infq1, tmpbq])
	subprocess.call(["perl", bin+"/bin/merge.stLFR.barcodes.pl", tmpbq, bin + "/SCRIPTS/4M-with-alts-february-2016.10x.txt", tmpmap, "8"])
	subprocess.call(["perl", bin+"/bin/stLFR.fake.10x.pl", infq1, infq2, tmpmap, outfq1, outfq2, tmpidx])	

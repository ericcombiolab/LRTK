...
def main(argv):
    ...
    ###preparations
    cmd="cp -r " + scriptdir + "css " + scriptdir + "js " + scriptdir + "img " + outdir
    ...
    ###ABD
    dec_text="<hr class=\"clear-contentunit-thin\" /><br/>Data distribution<br/>\n<div class=\"tc\"><a href=\"./img/abundance.png\" target=\"_blank\"><img style=\"width:720px\" src=\"./img/abundance.png\" /></a></div>\n"
    HTML.write(dec_text)

    ###PCA
    dec_text="<hr class=\"clear-contentunit-thin\" />\n<h1><a name=\"result.abundance\"></a> 2.1.1 Dimensionality Reduction </h1>\n<br/>Data distribution<br/>\n<div class=\"tc\"><a href=\"./img/pca.png\" target=\"_blank\"><img style=\"width:720px\" src=\"./img/pca.png\" /></a></div>\n"
    HTML.write(dec_text)

    ###Network
    dec_text="<hr class=\"clear-contentunit-thin\" />\n<h1><a name=\"result.abundance\"></a> 2.1.2 Network </h1>\n<br/>Data distribution<br/>\n<div class=\"tc\"><a href=\"./img/network.png\" target=\"_blank\"><img style=\"width:720px\" src=\"./img/network.png\" /></a></div>\n"
    HTML.write(dec_text)
    ...
    ###SNV number
    dec_text="<hr class=\"clear-contentunit-thin\"/>\n<br/>Data distribution<br/>\n<div class=\"tc\"><a href=\"./img/snv.png\" target=\"_blank\"><img style=\"width:720px\" src=\"./img/snv.png\" /></a></div>\n"
    HTML.write(dec_text)

    ###clustering
    dec_text="<hr class=\"clear-contentunit-thin\"/>\n<h1><a name=\"result.SNVs\"></a> 2.2.1 Unsupervised Clustering </h1>\n<br/>Data distribution<br/>\n<div class=\"tc\"><a href=\"./img/clustering.png\" target=\"_blank\"><img style=\"width:720px\" src=\"./img/clustering.png\"/></a></div>\n"
    HTML.write(dec_text)

    ##allelic imbalance
    dec_text="<h1><a name=\"result.SNVs\"></a> 2.2.2 Mirrored allelic imbalance</h1>\n<br/>Data distribution<br/>\n<div class=\"tc\"><a href=\"./img/MAI.png\" target=\"_blank\"><img style=\"width:720px\" src=\"./img/MAI.png\" /></a></div>"
    HTML.write(dec_text)
